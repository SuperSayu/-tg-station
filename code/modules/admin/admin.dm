...
/datum/admins/proc/Secrets()
	...
	if(check_rights(R_FUN,0))
		dat += {"
			...
			<A href='?src=\ref[src];secretsfun=radiation'>Trigger a normal radiation event</A><BR>
			<A href='?src=\ref[src];secretsfun=rad_gswap'>Trigger a Gender Swap radiation event</A><BR>
			<A href='?src=\ref[src];secretsfun=rad_pota'>Trigger a Planet of the Apes radiation event</A><BR>
			<A href='?src=\ref[src];secretsfun=rad_ffour'>Trigger a Fantasic Four radiation event</A><BR>
			<A href='?src=\ref[src];secretsfun=rad_healing'>Trigger a Healing radiation event</A><BR>

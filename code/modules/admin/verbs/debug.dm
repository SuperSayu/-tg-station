...
*/
		...
		if("blue wizard")
			...
			M.equip_to_slot_or_del(new /obj/item/weapon/magic/spellbook(M), slot_r_hand)
			M.equip_to_slot_or_del(new /obj/item/weapon/magic/staff(M), slot_l_hand)
		...
		if("marisa wizard")
			...
			M.equip_to_slot_or_del(new /obj/item/weapon/teleportation_scroll(M), slot_r_store)
			M.equip_to_slot_or_del(new /obj/item/weapon/magic/spellbook(M), slot_r_hand)
			M.equip_to_slot_or_del(new /obj/item/weapon/magic/staff/broom(M), slot_l_hand)
			M.equip_to_slot_or_del(new /obj/item/weapon/storage/backpack(M), slot_back)
			M.equip_to_slot_or_del(new /obj/item/weapon/storage/box(M), slot_in_backpack)
		if("soviet admiral")

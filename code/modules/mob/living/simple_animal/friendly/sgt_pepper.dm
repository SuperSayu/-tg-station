/mob/living/simple_animal/pet/dog/corgi/puppy/smart/sgt_pepper
	name = "Sgt. Pepper"
...
/mob/living/simple_animal/pet/dog/corgi/puppy/smart/sgt_pepper/New()
	if(isturf(loc) && type == /mob/living/simple_animal/pet/dog/corgi/puppy/smart/sgt_pepper && prob(10))
		new /mob/living/simple_animal/pet/dog/corgi/puppy/smart/sgt_pepper/steak(loc)
		qdel(src)
		return
	..()

/mob/living/simple_animal/pet/dog/corgi/puppy/smart
...
/mob/living/simple_animal/pet/dog/corgi/puppy/smart/proc/decide_interest(var/mob/M)
	...
	if(ishuman(M) && M.mind)
		...
		if(istype(M,/mob/living/simple_animal/pet/dog/corgi) && prob(45))
			like += M
			return
...
/mob/living/simple_animal/pet/dog/corgi/puppy/smart/proc/sniff_test(var/obj/item/weapon/reagent_containers/RC)
...
/mob/living/simple_animal/pet/dog/corgi/puppy/smart/Life()
	..()
...
/mob/living/simple_animal/pet/dog/corgi/puppy/smart/attack_animal(mob/living/simple_animal/M as mob)
	like -= M
	fears += M
	target = M
	..()

/mob/living/simple_animal/pet/dog/corgi/puppy/smart/attackby(var/obj/item/W as obj,var/mob/user as mob)
...
/mob/living/simple_animal/pet/dog/corgi/puppy/smart/attack_hand(var/mob/user as mob)
	if(iscarbon(user))
...
/mob/living/simple_animal/pet/dog/corgi/puppy/smart/sgt_pepper/steak

...
/obj/item/organ/internal/hivelord_core
	...
	desc = "Found in the remains of a hivelord, an organ which allows it to divide without being harmed... its healing properties will soon become inert if not used quickly."

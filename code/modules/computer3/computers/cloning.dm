...
/obj/machinery/computer/cloning
	...
	icon_state = "dna"
	circuit = "/obj/item/part/board/circuit/cloning"
	...
	var/obj/item/part/disk/data/diskette = null //Mostly so the geneticist can steal everything.
...
/obj/machinery/computer/cloning/attackby(obj/item/W as obj, mob/user as mob)
	if (istype(W, /obj/item/part/disk/data)) //INSERT SOME DISKETTES
		if (!src.diskette)
			user.drop_item()
			W.loc = src
			src.diskette = W
	...
	switch(src.menu)
		...
		if(3)
			...
			if (!src.active_record)
				...
				var/obj/item/part/ammo/implant/health/H = locate(src.active_record.fields["imp"])
...
/obj/machinery/computer/cloning/proc/scan_mob(mob/living/carbon/human/subject as mob)
	...
	var/obj/item/part/ammo/implant/health/imp = locate(/obj/item/part/ammo/implant/health, subject)
	if (isnull(imp))
		imp = new /obj/item/part/ammo/implant/health(subject)

...
/obj/item/weapon/storage/bag/seeds/New()
	..()
	pixel_x = rand(-10,10)
	pixel_y = rand(-10,0)

/obj/item/weapon/storage/bag/seeds/update_icon()
	...
	if(contents.len > 0 && !seedtype)
		...
		overlays += image('icons/obj/hydroponics/seeds.dmi', icon_state=S.icon_state)
		seedtype = S.type

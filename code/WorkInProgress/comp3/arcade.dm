/obj/machinery/computer/arcade
	...
	icon_state = "arcade"
	underlay = new/datum/file/program/arcade

/obj/item/weapon/computer_part/storage/removable/datadisk/arcade
	name = "Space Fantasy II"
	desc = "A Data Disk storing the install information for Space Fantasy II: The Spacelike RPG of the future!"
	volume = 170 // in KB
	icon_state = "datadisk_arcade"
	files = list("/datum/file/program/arcade")
...
/datum/file/program/arcade/interact(mob/user as mob)
	if(..())
		return
...
/datum/file/program/arcade/Topic(href, list/href_list)
	...
	else if ("newgame" in href_list) //Reset everything
		temp = "New Round"
		player_hp = 30
		player_mp = 10
		enemy_hp = 45

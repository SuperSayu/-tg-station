...
#define ui_toxin "EAST-1:28,CENTER+5:19"
#define ui_fire "EAST-1:28,CENTER+4:18"
#define ui_oxygen "EAST-1:28,CENTER+3:22"
#define ui_pressure "EAST-1:28,CENTER+3:3"
...
#define ui_ai_camera_bug "SOUTH+1:6,WEST:16"
